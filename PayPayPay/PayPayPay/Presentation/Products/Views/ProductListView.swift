...
struct ProductListView: View {
    ...
    var body: some View {
            ...
            ZStack {
                ZStack {
                    VStack {
                        ...
                        List(self.viewModel.state.items.filter { searchText.isEmpty ? true : $0.nameText.contains(searchText)}) { ( model) in
        ...
        .toast(isShowing: Binding(get: { viewModel.state.isShowingError }, set: { if !$0 { viewModel.dismissError() } }),
